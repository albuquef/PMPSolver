...
PATH_CLUSTER=falbuquerque@poseidon:/users/falbuquerque/Projects/Project_PMP/test_all_coverages/
...
PATH_LOCAL=/home/felipe/Documents/save_cluster/test_all_coverages/
